...
def optimize(pm_object, path_data, path_results, solver):
    ...
    generation_data_before = pm_object.get_profile_data()
    ...
    if len(pm_object.get_final_generator_components_names()) > 0:
        ...
        if pm_object.get_commodity_data_needed():  # Case market data available
            ...
            if pm_object.get_single_or_multiple_profiles() == 'single':  # Case single file generation
                ...
                path_to_generation_files = path_data + pm_object.get_profile_data()
                pm_object.set_profile_data(path_to_generation_files)
                ...
                if pm_object.get_single_or_multiple_commodity_profiles() == 'single':
                    ...
                    for fg in filenames_generation:
                        pm_object.set_profile_data(path_to_generation_files + '/' + fg)
    ...
    pm_object.set_profile_data(generation_data_before)
