...
def _transfer_gurobi_results_to_parameter_object(pm_object):
    ...
    if False:
        ...
        all_vars = pm_object.instance.model.getVars()
        values = pm_object.instance.model.getAttr("X", all_vars)
        names = pm_object.instance.model.getAttr("VarName", all_vars)
        ...
        for generator in pm_object.get_final_generator_components_names():
            ...
            if capacity != 0:
                ...
                time_depending_variables_local[
                    ...
                    = generator_profile.loc[covered_index].tolist()
