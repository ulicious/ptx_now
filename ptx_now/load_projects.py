...
def load_008(pm_object, case_data):
    ...
    pm_object.set_path_weighting(case_data['representative_periods']['path_weighting'])
    ...
    """ Add generation data """
    pm_object.set_single_or_multiple_generation_profiles(case_data['generation_data']['single_or_multiple_profiles'])
    pm_object.set_generation_data(case_data['generation_data']['generation_data'])
...
def load_007(pm_object, case_data):
    ...
    pm_object.set_single_or_multiple_generation_profiles(generation_data_df.loc[index, 'single_profile'])
